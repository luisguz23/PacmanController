...
public class MainActivity extends AppCompatActivity implements SensorEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView6 = findViewById(R.id.textviewExtra);
    ...
    public void onSensorChanged(SensorEvent event) {
        if (event.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
            ...
            String data = "X:" + x;
            EnviarInfo( data); // Llama al método que envía los datos a través del socket
    ...
    private void Refresh(){
        ...
        SERVER_IP = "";
        textView4.setText(R.string.textview4);
        textView5.setText("No se ha presionado el botón");
    }

    private void EnviarInfo(String data) {
        ...
        new Thread(() -> {
            ...
            try {
                ...
                //String message = "Hola, soy el dispositivo Android, he enviado este mensaje " + contadorDePulsaciones + a;
                String message =data;
                output.printf(message);
                Log.d("ENVIADO", message);

                runOnUiThread(() -> textView6.setText("Esperando respuesta\nSi no responde en poco tiempo,\nes posible que no haya conexión"));
                ...
                runOnUiThread(() -> textView6.setText("NADIE ESCUCHA EN ESE PUERTO\n" +
    ...
    private void Contador() {
        ...
        if (contadorDePulsaciones == 1) {
            textView5.setText("Se ha presionado el botón " + contadorDePulsaciones + " vez");
        } else {
            textView5.setText("Se ha presionado el botón " + contadorDePulsaciones + " veces");
        }
    }
